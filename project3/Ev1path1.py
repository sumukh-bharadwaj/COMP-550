...
#Environment2    ax.add_patch(patches.Polygon([(-0.45,0.2),(-0.45,-0.95),(0.25,-0.95),(0.25,0.2)], fill=True, color='0.20'))
...
def plotSE2(path):
    ...
    boxVert = [[-0.05, -0.05], [0.05, -0.05], [0.05, 0.05], [-0.05, 0.05], [-0.05, -0.05]]
